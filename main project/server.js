...
const homeRoutes = require('./routes/home'); // Import the logout router
...
// we need this route because this  http://localhost:3000/home/home  and this is due to res.redirect(`/home/${Name}`); define at end
// app.get('/', isAuthenticated , (req, res) => {
//   const filePath = path.join(directoryPath, 'dashboard.html');                  
//   res.sendFile(filePath); 
// });
...
app.use( (req, res) => {
  const directoryPath = path.join('C:\\main project\\public\\html');
  const errorFilePath = path.join(directoryPath, '404.html');
